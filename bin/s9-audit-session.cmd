@echo off
rem section9 Windows entry for `s9-audit-session`  --  see docs/11-windows.md (REQ-20260903-005)
...
:run
if "%S9_PY%"=="py" (py -3 "%~dp0s9-audit-session" %*) else ("%S9_PY%" "%~dp0s9-audit-session" %*)
exit /b %ERRORLEVEL%
